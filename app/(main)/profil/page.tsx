    ...
    try {
      const res = await fetch("/api/patient/update", {
        ...
        body: JSON.stringify({
          ...
          fullName: user?.name,
          age: user?.umur,
          weight: user?.beratBadan,
          height: user?.tinggiBadan,
          gender: user?.gender,
          bloodType: user?.golonganDarah,
          allergy: user?.alergi,
          address: user?.alamat,
        }),
      });
      ...
      <main className="flex flex-col items-start px-6 pt-11 pb-8 gap-4">
        ...
        <Card className="mb-6 w-full outline-0 shadow-md">
          ...
          <CardContent className="grid gap-6">
            <div className="grid grid-cols-2 gap-15 items-center self-stretch">
              ...
              <div>
                <Label
                  className="mb-3 font-semibold text-[16px]"
                ...
                <Input
                  className={clsx(
                    "p-6",
                    UpdateForm ? "bg-gray-100" : "bg-white"
                  )}
                  id="nama-lengkap"
              ...
              <div>
                <Label
                  className="block mb-3 font-semibold text-[16px]"
                  htmlFor="umur-pasien"
                >
                  Umur Pasien
                </Label>
                <div className="flex items-center">
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      updateUser({
                        umur: val === "" ? undefined : parseFloat(val),
                      });
                    }}
                  />
                </div>
                ...
                <div className="flex items-center">
                  <Input
                    ...
                    onChange={(e) => {
                      const val = e.target.value;
                      updateUser({
                        beratBadan: val === "" ? undefined : parseFloat(val),
                      });
                    }}
                  />
                </div>
                ...
                <div className="flex items-center">
                  <Input
                    ...
                    onChange={(e) => {
                      const val = e.target.value;
                      updateUser({
                        tinggiBadan: val === "" ? undefined : parseFloat(val),
                      });
                    }}
                  />
                </div>
              ...
              <div className="grid grid-cols-2 gap-4 mt-2">
                {genderOptions.map((option) => (
                  <label
                    ...
                    className={clsx(
                      "relative flex flex-col items-start justify-center p-4 rounded-lg cursor-pointer border-2",
            ...
            {/* Riwayat Alergi */}
            <div className="mt-4">
              <Label className="font-bold text-[16px]" htmlFor="riwayat-alergi">
                Riwayat Alergi Obat
              </Label>
        ...
        <Card className="w-full">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Button
              onClick={() => setUpdateBotForm(!UpdateBotForm)}
              variant="outline"
              size="sm"
              className={clsx(
                "ring-1 ring-gray-300 transition-all duration-300",
          ...
          <CardContent className="grid gap-4 text-gray-500 font-light">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="gap-4">
                <Label className="block mb-1 text-[16px]" htmlFor="negara">
                  Negara
                </Label>
                <Input
                  className={clsx(
                    "p-6",
                    UpdateBotForm ? "bg-gray-100" : "bg-white"
                  )}
                  id="negara"
              ...
              {/* Kota */}
              <div>
                <Label className="block mb-1 text-[16px]" htmlFor="kota">
                  Kota
                </Label>
                <Input
                  className={clsx(
            ...
            {/* Kode POS */}
            <div>
              <Label className="block mb-1 text-[16px]" htmlFor="kode-pos">
                Kode POS
              </Label>
              <Input
                className={clsx(
        ...
        <footer className="mt-6 text-xs items-center text-muted-foreground">
          Setiap informasi pribadi yang Anda berikan akan terlindungi. Kami
          menjaga kerahasiaan data pribadi Anda dan tidak akan menyebarluaskan
          kepada pihak yang tidak berkepentingan. Informasi pribadi dipergunakan
          semata-mata untuk keperluan administrasi, penjadwalan, serta
          kelancaran komunikasi antara pasien dan tenaga medis.
        </footer>
      </main>
